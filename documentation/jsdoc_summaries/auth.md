# Full Source Code for `src/lib/auth.ts`

This file contains the complete source code for `src/lib/auth.ts`, including any JSDoc comments previously added.
 ...
 * @param {({ id?: string, name?: string } | string | null)} [roleInfo] - Optional role information for the user. Can be a role name string,
 ...
 * @returns {Promise<object|null>} A promise that resolves to the token payload if verification is successful,
 ...
 * @returns {Promise<object|null>} A promise that resolves to the session payload if a valid session token exists,
 ...
 * @returns {Promise<object>} A promise that resolves to the created session object from the database.
 */
